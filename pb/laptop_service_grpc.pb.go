...
type LaptopServiceClient interface {
	...
	SearchLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (LaptopService_SearchLaptopClient, error)
}
...
func (c *laptopServiceClient) CreateLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (*CreateLaptopResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/techschool.proto.LaptopService/CreateLaptop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *laptopServiceClient) SearchLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (LaptopService_SearchLaptopClient, error) {
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[0], "/techschool.proto.LaptopService/SearchLaptop", opts...)
	if err != nil {
		return nil, err
	}
...
type LaptopServiceServer interface {
	...
	SearchLaptop(*CreateLaptopRequest, LaptopService_SearchLaptopServer) error
...
func (UnimplementedLaptopServiceServer) SearchLaptop(*CreateLaptopRequest, LaptopService_SearchLaptopServer) error {
...
func _LaptopService_CreateLaptop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/techschool.proto.LaptopService/CreateLaptop",
	}
...
var LaptopService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "techschool.proto.LaptopService",
